...
If InStr(file_contents, "python") > 0 Then
    path = "D:\AutoMaa\Python\Special\Start.py"
ElseIf InStr(file_contents, "conda") > 0 Then
    path = "conda run -n Automaa python D:\AutoMaa\Python\Special\Start.py"
Else
    path = "D:\AutoMaa\Python\Ordinary\Special\Start.py"
End If
